...
export function JudgmentPanel({ originalEval, currentEval, prefChanged }: JudgmentPanelProps) {
  ...
  return (
    <motion.div
      layout
      className={`grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 p-5 rounded-xl border transition-colors ${prefChanged ? 'bg-amber-500/5 border-amber-500/30' : 'bg-emerald-500/5 border-emerald-500/10'}`}
    >
      <div>
